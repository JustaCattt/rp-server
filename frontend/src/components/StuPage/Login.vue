<template>
  <div id="login-box">
    ...
    <form>
      ...
      <a id="admin" href="#/adminlogin">Admin Login</a>
    ...
    login() {
      ...
      this.$axios({
        ...
        .then(res => {
          ...
          localStorage.setItem('userId', res.data.userId); //将userId存到localstorge中，作为后续用户登录标识
          localStorage.setItem('stuId', res.data.stuId); //将学号存入localstorage中，后续查询学生信息需要
          if (res.data.state) {
